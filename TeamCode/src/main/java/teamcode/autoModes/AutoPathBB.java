...
@Autonomous(name="Path Bottom B", group="Auto Modes")


public class AutoPathBB extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        move("F", 3000, 1);//move to depot
        //deposit team marker
        move("B", 2000, 1);//backwards to dodge ball
        move("R", 2500, 1);//right to dodge the lander
        move("B", 2000, 1);//over to the crater
        move("R", 2000, 1);//move into the crater
    ...
    public void move(String direction, int distance, double speed){
        ...
        else if(direction == "UL"){//up left diagonal
        ...
        else if(direction == "UR"){//up right diagonal
        ...
        else if(direction == "DR"){//down right diagonal
        ...
        else if(direction == "DL") {//down left diagonal
